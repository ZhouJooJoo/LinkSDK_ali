...
/*     snprintf(demo_request_uri, 200, "%s%s%s%s%s", "/topic/sys/", product_key, "/", device_name,
    ...
    const char *demo_request_payload = "{\"dac_sn\":\"ofd21f24a\",\"discriminator\":\"3432\",\"passcode\":\"4693563\",\"vendor_id\":\"0x1351\",\"product_id\":\"0xFFFB\"}";
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    其中包含了根据device_secret生成的需要服务器确认的auth msg */
